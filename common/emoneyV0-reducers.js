...
function totalBackedValueReducer(
  totalBackedValue,
  exchangeRates,
  reducers,
  network
...
function getTotalNetworkAnnualRewards(inflations, totalBackedValues) {
...
function expectedRewardsPerTokenReducer(
  validator,
  commission,
...
module.exports = {
  ...terraV3Reducers,
  expectedRewardsPerTokenReducer,
