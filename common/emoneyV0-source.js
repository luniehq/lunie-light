...
class EMoneyV0API extends TerraV3API {
  setReducers() {
    this.reducers = require('./emoneyV0-reducers')
  }
  ...
  async getValidators(height) {
    return await CosmosV0API.prototype.getValidators.call(this, height)
  }
  ...
  async getExpectedReturns(validator) {
    ...
    const expectedReturns = this.reducers.expectedRewardsPerTokenReducer(
      validator,
